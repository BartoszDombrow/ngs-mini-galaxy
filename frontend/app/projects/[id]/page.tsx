          ...
          <div className="relative z-10 flex flex-col justify-between gap-6 md:flex-row md:items-start">
            ...
            <div className="flex w-full shrink-0 flex-col gap-3 md:w-[220px]">
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 rounded-full border border-line bg-card/80 px-6 py-3.5 text-sm font-semibold text-foreground shadow-sm transition-all duration-300 hover:bg-white/10 hover:border-line/80 active:scale-95"
              >
              ...
              <div className="space-y-3 max-h-[500px] overflow-y-auto pr-2 custom-scrollbar">
                {jobs.length ? (
                  jobs.map((job) => (
                    <div
                      key={job.id}
                      className="pill group flex items-center gap-3 rounded-2xl px-5 py-4 text-sm transition-all duration-300 hover:-translate-y-1 hover:border-line hover:bg-background/70 hover:shadow-lg"
                    >
                  ...
                  <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-line/40 bg-white/5 p-12 text-center">
      ...
      >
        <div className="flex max-h-[92vh] min-h-0 flex-col p-4 sm:p-8">
          ...
          <div className="min-h-0 space-y-6 overflow-y-auto pr-1 custom-scrollbar">
            <div className="rounded-[1.5rem] border border-line/60 bg-background/60 p-4 sm:p-5">
              ...
              <div className="space-y-2">
                {project?.uploads.length ? (
                  project.uploads.map((file) => (
                    <div key={file.id} className="pill flex items-center gap-3 rounded-2xl border border-line/50 px-4 py-3 text-sm transition-all hover:bg-background/70 sm:px-5">
                      ...
                      <div className="ml-auto flex items-center">
                        <button
                          ...
                          className="p-2 text-muted hover:text-danger transition-colors rounded-full hover:bg-white/10"
                          title="Usuń plik"
                        >
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg>
                        </button>
                  ...
                  <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-line/40 bg-white/5 p-8 text-center">
